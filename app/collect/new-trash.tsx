...
export default function NewTrash() {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* location={location}  */}
            {base64Picture ? <TrashDetails base64Picture={base64Picture} city={city} country={country} /> :
...
function TrashDetails({ base64Picture, city, country }: { base64Picture: string, city: string | null, country: string | null }) {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Submit Button */}
            <TouchableOpacity style={[buttonStyles.primary, detailsStyles.submitButton]}>
